    ...
    <div class="grid-item" id="language">
      ...
      <form action="process-generate-playlist.php" method="post" id="getSelectedbox">
        <table id="check_language">
          ...
          <td><select name="choose_language1" id="choose_language1">
              <option value="select">Select</option>
          ...
          <td><select name="choose_language2" id="choose_language2">
              <option value="select">Select</option>
              <option value="English">English</option>
              <option value="Spanish">Spanish</option>
              <option value="French">French</option>
          ...
          <td><select name="choose_language3" id="choose_language3">
              <option value="select">Select</option>
              <option value="English">English</option>
              <option value="Spanish">Spanish</option>
              <option value="French">French</option>
